...
Un table vous sera installée avec accès à une prise électrique. Vous devez lister l'ensemble du matériel nécessaire à la présentation de votre démontration, absolument tous :
...
3. Deux caméra externe
4. Deux Fil HDMI
5. Branchement au minimum 6 prises
6. Deux écran assez grande (min 40po)
7. Amplificateurs de volume si possible (Haut-parleur, enceinte, etc)

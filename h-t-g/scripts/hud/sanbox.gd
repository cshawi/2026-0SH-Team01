...
const full_motion_object = preload("res://scenes/moveables/full_motion_object.tscn")
const horizontal_motion_object = preload("res://scenes/moveables/horizontal_motion_object.tscn")
const moveable_object = preload("res://scenes/moveables/moveable_object.tscn")
const verticale_object = preload("res://scenes/moveables/vertical_motion_object.tscn")
